...
@Component({
  selector: 'app-intergral-detail',
  templateUrl: './intergral-detail.component.html',
  styleUrls: ['./intergral-detail.component.css']
})
export class IntergralDetailComponent implements OnInit {
