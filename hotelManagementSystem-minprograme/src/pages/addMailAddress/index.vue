  ...
  <div>
   <ul class="adduser">
    ...
    <view class="picker" style="font-size:30rpx;">
     ...
     <li :class="{'err':travalUserErr.IdCard}"><span>详细地址</span><input type="text" placeholder="请输入地址"  v-model="travalUser.IdCard"></li>
     <li  style="color:red;font-size:26rpx" v-if="travalUserErr.IdCard">{{travalUserErr.IdCard}}</li>
      <li :class="{'err':travalUserErr.Mobile}"><span>邮政编码</span><input type="text" name="" id="" placeholder="请输入邮政编码" v-model="travalUser.Mobile" @input="validMobile()"></li>
      <li  style="color:red;font-size:26rpx" v-if="travalUserErr.Mobile">{{travalUserErr.Mobile}}</li>
   </ul>
